...
class ThrowerAnt(Ant):
    ...
    # Why this can lead into infinite loop?
    # def __init__(self, health=1):
    #     super().__init__(self)
    ...
    def nearest_bee(self):
        ...
        i = 0
        find_pointer = self.place
        while find_pointer.is_hive == False:
            if not self.lower_bound <= i <= self.upper_bound:
                find_pointer = find_pointer.entrance
                i += 1
                continue
            # print("DEBUG", i, self.place, find_pointer.bees)
            if find_pointer.bees != []:
                return random_bee(find_pointer.bees)
            else:
                find_pointer = find_pointer.entrance
                i += 1
        ...
        # i = 0
        # find_pointer = self.place
        # while self.lower_bound <= i < self.upper_bound:
        #     print("DEBUG:", i, find_pointer.is_hive)
        #     if find_pointer.is_hive:
        #         return None
        #     elif find_pointer.bees != []:
        #         print(find_pointer.bees)
        #         return random_bee(find_pointer.bees)
        #     else:
        #         find_pointer = find_pointer.entrance
        #         i += 1
    ...
    def action(self, gamestate):
        ...
        # print("DEBUG:", "THROWING AT", self.nearest_bee())
    ...
    def reduce_health(self, amount):
        ...
        if self.health - amount <= 0:
            for bee in bee_lst:
                ...
                print("DEBUG:", bee)
        # super().death_callback()
        super().reduce_health(amount)
        # if bee.health <= 0

        # curr_place.bees = bee_lst
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8a
        # if type(other) != "ants.ThrowerAnt":
        # print("DEBUG:", type(other))
...
class BodyguardAnt(ContainerAnt):
    ...
    # def __init__(self, health=4, ant_contained=None):
    #     super().__init__(health, ant_contained)
    def __init__(self, health=2):
        super().__init__(health)
        ant_containe = None

    # def can_contain(self, other):
    #     print("DEBUG:", "BODYGAUARD CAN_CONTAIN")
    #     super().can_contain(other)
    # END Problem 8c
...
class TankAnt(BodyguardAnt):
    ...
    def action(self, gamestate):
        ...
        for bee in bee_list:
            bee.reduce_health(self.damage)
        print("DEBUG:", self.ant_contained)
        if self.ant_contained != None:
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, gamestate):
        ...
        while place_pointer is not None:
            print("DEBUG:", place_pointer.ant)
            if place_pointer.ant is None:
                place_pointer = place_pointer.exit
                continue
            if place_pointer.ant.is_doubled == False:
                place_pointer.ant.damage *= 2
                place_pointer.ant.is_doubled = True

            if place_pointer.ant.is_container:
                if not place_pointer.ant.ant_contained == None:
                    # and place_pointer.ant.ant_contained is not None:
                    if place_pointer.ant.ant_contained.is_doubled == False:
                        place_pointer.ant.ant_contained.damage *= 2
                        place_pointer.ant.ant_contained.is_doubled = True
            place_pointer = place_pointer.exit
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        # print("DEBUG:", self.scary_turns)
        if self.scary_turns > 0 :
            ...
            if self.slowed_turns == 0:
                ...
                self.scary_turns -= 1
        if self.scary_turns == 0 and self.has_scaried:
            destination = self.place.exit
    ...
    def scare(self, length):
        ...
        """
        # BEGIN Problem EC
        if not self.has_scaried:
            self.scary_turns += length
            self.has_scaried = True
